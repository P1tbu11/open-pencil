...
const meta = {
  ...
  render: () => ({
    components: { FileIcon, SegmentedControl, XIcon },
    setup() {
      return {
        pageStyles,
        tabStyles,
        panelTabsUI: { root: 'w-full' },
        panelOptions,
        pageStates
      }
    },
          ...
          <div class="mt-3 space-y-1">
            ...
            >
              ...
              <button :class="pageStyles({ active: state.active }).item()">
                <FileIcon :class="pageStyles().icon()" />
