 ...
 * the reader has no replacement to guess at. Opening a file skips those records and
 * reports them; a swap whose replacement is missing is still a structural failure.
 */
